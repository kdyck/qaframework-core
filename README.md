...
# qaframework-core [![][Logo]][GitHub Repository]

QAFramework Core leverages open-source libraries to provide tools and utilities for core Selenium WebDriver automation. 
Driver Package:
* DriverFactory setup for common web browsers tests
* WebDriver setup with thread management to allow parallel test runs
* FluentWaits for polling and timeouts 
* UserAgent and Proxy connection randomizer driver utils

Utils Package: 
* JsoupLinkExtractor, PropertiesUtils, SeleniumUtils

Resources: 
* Logging via Log4j2 implementation

QAFramework-Core is open source, released under the terms of [Apache 2.0 License].

## Table of contents

1. [WebDriverManager as Java dependency](#webdrivermanager-as-java-dependency)
   1. [Basic usage](#basic-usage)
   2. [Examples](#examples)
   3. [Driver versions](#driver-versions)
   4. [WebDriverManager API](#webdrivermanager-api)
   5. [Configuration](#configuration)
2. [WebDriverManager CLI](#webdrivermanager-cli)
3. [WebDriverManager server](#webdrivermanager-server)
